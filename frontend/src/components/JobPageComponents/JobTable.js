...
const JobTable = ({ handleDelete, handleUpdate }) => {
  ...
  useEffect(() => {
    dispatch(getJobs()).then((res) => setLoading(false));
  }, [dispatch]);
                  ...
                  <tbody>
                    {jobsData?.jobs.length ? (
                        ...
                        (
                          ...
                          >
                            ...
                            <td className="px-5 py-5 text-sm text-right flex justify-center">
                              <BlueCommenBtn
                                title="convertToInvoice"
                                disabled={isCovertedToInvoice}
                                onClick={HandlConvertToInvoice}
                                data={_id}
                              />
                            </td>
                          </tr>
                      ...
                      <tr className=" border-[1px] rounded-b-md ">
                        <td
                          colSpan="10"
                          className="px-4 py-3 text-center text-gray-500 rounded-b-md"
                        >
                          No data available
                        </td>
                      </tr>
